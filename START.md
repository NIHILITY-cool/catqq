...
白名单用户也可以用"小猫任务"让小猫现在或到点后联系某个联系人。推荐写法是固定入口 + 自然话：
...
不写时间就是现在发；写了时间会存成任务，到点后自动发。支持"现在/马上/立刻"、"10分钟后/半小时后/2小时后"、"下午三点/今晚九点/明早八点/明天下午三点/16:00"这类表达。时间可以放在动作前，也可以放在联系人后，例如"半小时后提醒鲍鲍喝水"和"提醒鲍鲍半小时后喝水"都可以。

小猫会直接私聊目标联系人，并给发起人回复确认。带"小猫任务："前缀的消息不会交给 AI 猜，避免出现"鲍鲍没找我"这类误判。少数很明确的直接句式也会兼容，例如"现在去给鲍鲍考试加油"、"去问问鲍鲍吃药没"。
